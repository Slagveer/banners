...
// stage content:
(lib.main468x60 = function() {
	this.initialize();

	// click
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("EAkfAEnMhI9AAAIAApNMBI9AAAIAAJN").cp();
	this.shape.setTransform(233.5,29.5);

	// info
	this.info = new lib.mcmeerinfo();
	this.info.setTransform(328,30);
	...
	// hand
	this.hand2 = new lib.mchand();
	this.hand2.setTransform(495.5,236);
	...
	// tafel
	this.tafel2 = new lib.mctafel();
	this.tafel2.setTransform(578.5,132.8);

	this.tafel = new lib.mctafel();
	this.tafel.setTransform(78.2,123.2);

	// dj
	this.dj2 = new lib.animdj();
	this.dj2.setTransform(575.4,45.4,1,1,0,0,0,2,23.9);

	this.dj = new lib.animdj();
	this.dj.setTransform(80,36,1,1,0,0,0,2,23.9);

	// mensen
	this.mensenlinks = new lib.mcpeople();
	this.mensenlinks.setTransform(269.2,282.6,1,1,0,0,0,1.2,-0.4);

	this.mensenrechts = new lib.mcpeople();
	this.mensenrechts.setTransform(447.2,282.6,1,1,0,0,0,1.2,-0.4);
	...
	// record
	this.record2 = new lib.animrecord();
	this.record2.setTransform(398.5,109.5);

	this.record = new lib.animrecord();
	this.record.setTransform(70,109.5);

	this.addChild(this.record,this.record2,this.title,this.mensenrechts,this.mensenlinks,this.dj,this.dj2,this.tafel,this.tafel2,this.djtitle,this.laptop,this.laptoptitle,this.hand,this.hand2,this.geldtitle,this.info,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-180.3,-69.9,1180.4,738);
...
(lib.wordteendjeps = function() {
	...
	// wordteendj.eps
	this.text = new cjs.Text("Wordt een DJ!", "bold 24px ", "#2B2B2A");
	this.text.lineHeight = 29;
	this.text.setTransform(0,1.4);

	this.addChild(this.text);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,1.4,156.7,24);
...
(lib.nietgoedgeldterugeps = function() {
	...
	this.text_1 = new cjs.Text("Niet goed, \n           geld terug!", "bold 24px ", "#2B2B2A");
	this.text_1.lineHeight = 29;
	this.text_1.setTransform(0,1.4);

	this.addChild(this.text_1);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,1.4,167.7,52.8);
...
(lib.metjelaptopeps = function() {
	...
	// metjelaptop.eps
	this.text_2 = new cjs.Text("Met je laptop!", "bold 24px ", "#2B2B2A");
	this.text_2.lineHeight = 29;
	this.text_2.setTransform(0,1.4);

	this.addChild(this.text_2);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,1.4,150.8,24);
...
(lib.logozwart_outlineseps = function() {
	...
	this.shape_5.graphics.f("#2B2B2A").s().p("").cp();
	this.shape_5.setTransform(537.1,46.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#2B2B2A").s().p("").cp();
	...
	this.shape_15.graphics.f("#2B2B2A").s().p("").cp();
	...
	this.shape_17.graphics.f("#2B2B2A").s().p("AC6hrQgTgygkgkQgkglgxgTQgxgUg7AAIiYAAIAAIbICYAAQA8AAAwgUQAygSAjglQAkgkATgwQAUgwAAg9IAAgCQAAg6gUgxIAAAAAGcAAQAABfgiBRQgjBTg/A7Qg/A8hYAjQhYAihnAAIldAAIAAt9IFdAAQBoAABXAhQBZAjA+A7QA/A9AjBRQAiBSAABeIAAAB").cp();
...
(lib._20141201_MEERINFObutton_wittebannereps = function() {
	this.initialize();

	// 20141201_MEERINFObutton_wittebanner.eps
	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#FFFFFF").s().p("").cp();
	this.shape_54.setTransform(77.1,72.1);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#FFFFFF").s().p("AAvg0IhBAAIAAAtIA3AAIAAAUIg3AAIAAA+IgcAAIAAiWIBdAAIAAAX").cp();
	this.shape_55.setTransform(63.3,72.1);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#FFFFFF").s().p("AglgQIAABbIgZAAIAAiWIAPAAIAFABQABAAAAACIACACIBPBkIgCgOIAAhbIAZAAIAACWIgOAAIgGgBQgCgCgCgCIhOhjIACAN").cp();
	this.shape_56.setTransform(48.8,72.1);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#FFFFFF").s().p("AAOBLIgbAAIAAiWIAbAAIAACW").cp();
	this.shape_57.setTransform(37.5,72.1);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#FFFFFF").s().p("AgMg0IgSAAIAAAyIASAAQAGAAAGgCQAGgCAEgEQAEgEABgEQACgEAAgHQAAgLgHgHQgIgFgOAAIAAAAAANhHQALADAHAGQAHAFADAIQAEAIAAAKQAAAJgCAGQgCAFgFAHQgDAEgHAEQgHAEgIADQAFACAFAHIAmA4IgaAAQgHAAgDgGIgegxQgDgDgBgBQgCgBgFAAIgMAAIAAA8IgcAAIAAiXIAuAAQAOAAALAEIAAAA").cp();
	this.shape_58.setTransform(82.9,46.9);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#FFFFFF").s().p("AAvhLIAAAXIhBAAIAAAqIAzAAIAAAUIgzAAIAAArIBBAAIAAAXIheAAIAAiXIBeAA").cp();
	this.shape_59.setTransform(69.7,46.9);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#FFFFFF").s().p("AAvhLIAAAXIhBAAIAAAqIAzAAIAAAUIgzAAIAAArIBBAAIAAAXIhdAAIAAiXIBdAA").cp();
	this.shape_60.setTransform(57.6,46.9);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#FFFFFF").s().p("ABShLIAACXIgZAAIAAhhIAAgMIgtBUQgEAGgGAAIgCAAQgHAAgDgGIgvhVIABAHIAABnIgZAAIAAiXIAZAAIAEADIAzBcIABAGIAzhgIACgCIAEgDIAZAA").cp();
	this.shape_61.setTransform(41.2,46.9);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#F50050").s().p("AI7i4IhNBrIBqBNIhqBNIBNBsIh+AqIAoB9IiEABIAACEIh+goIgqB9IhrhMIhOBqIhMhqIhsBMIgqh9Ih9AoIgBiEIiEgBIAoh9Ih9gqIBNhsIhrhNIBrhNIhNhrIB9gqIgoh9ICEgBIABiEIB9AoIAqh9IBsBMIBMhqIBOBqIBrhMIAqB9IB+goIAACEICEABIgoB9IB+Aq").cp();
	this.shape_62.setTransform(60,60);

	this.addChild(this.shape_62,this.shape_61,this.shape_60,this.shape_59,this.shape_58,this.shape_57,this.shape_56,this.shape_55,this.shape_54);
}).prototype = p = new cjs.Container();
...
(lib.mcmeerinfo = function() {
	this.initialize();

	// Laag 1
	this.instance_7 = new lib._20141201_MEERINFObutton_wittebannereps("synched",0);
	this.instance_7.setTransform(0,0,1,1,0,0,0,60,60);
...
(lib.mclaptoptittel = function() {
	...
	// Laag 1
	this.instance_8 = new lib.metjelaptopeps("synched",0);
	this.instance_8.setTransform(75.4,0,1,1,0,0,0,75.4,13.3);

	this.addChild(this.instance_8);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,-11.9,150.8,24);
...
(lib.mchand = function(mode,startPosition,loop) {
	...
	// Laag 1
	this.instance_9 = new lib.handeps("synched",0);
	this.instance_9.setTransform(0,0,1,1,0,0,0,226.4,306);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({y:-79.8},4).to({startPosition:0},1).to({y:0},4).to({startPosition:0},5).to({startPosition:0},1).to({y:-79.8},4).to({startPosition:0},1).to({y:0},4).wait(1));
...
(lib.mcgeldtitel = function() {
	...
	// Laag 1
	this.instance_10 = new lib.nietgoedgeldterugeps("synched",0);
	this.instance_10.setTransform(115.4,-8.9,1,1,0,0,0,115.4,13.3);

	this.addChild(this.instance_10);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,-20.9,167.7,52.8);
...
(lib.mcdjtitel = function() {
	...
	// Laag 1
	this.instance_11 = new lib.wordteendjeps("synched",0);
	this.instance_11.setTransform(6.1,-6.9,1,1,0,0,0,78.4,13.3);

	this.addChild(this.instance_11);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-72.2,-18.9,156.7,24);
...
(lib.mclichaam = function() {
	...
	// Laag 1
	this.instance_12 = new lib.dj_lichaameps("synched",0);
	this.instance_12.setTransform(2.1,23,1,1,0,0,0,14.8,38.1);
...
(lib.mckoptelefoon = function() {
	...
	// Laag 1
	this.instance_13 = new lib.dj_koptelefooneps("synched",0);
	this.instance_13.setTransform(0,110,17.476,17,0,0,0,10.5,6.5);
...
(lib.animkoptelefoon = function(mode,startPosition,loop) {
	...
	// Laag 1
	this.instance_14 = new lib.mckoptelefoon();
	this.instance_14.setTransform(-0.9,111.4,1,1,0,0,0,0,110.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({scaleX:1.19,y:85.5},4).to({scaleX:1,y:111.4},5).wait(1));
...
(lib.mchoofd = function() {
	...
	// Laag 1
	this.instance_15 = new lib.dj_hoofdeps("synched",0);
	this.instance_15.setTransform(-0.2,-0.2,11.858,11.857,0,0,0,6.3,6.3);
...
(lib.mcdj = function() {
	...
	// Laag 1
	this.instance_16 = new lib.mchoofd();
	this.instance_16.setTransform(-1.4,-28.4,0.067,0.067);

	this.instance_17 = new lib.mclichaam();
	this.instance_17.setTransform(0,0,1,1,0,0,0,2,23);

	this.addChild(this.instance_17,this.instance_16);
}).prototype = p = new cjs.Container();
...
(lib.animlichaam = function(mode,startPosition,loop) {
	...
	// Laag 1
	this.instance_18 = new lib.mcdj();
	this.instance_18.setTransform(0.1,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).to({y:-1.7},4).to({y:0},5).wait(1));
